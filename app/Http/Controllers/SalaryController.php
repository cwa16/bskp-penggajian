...
class SalaryController extends Controller
{
    ...
    public function printall(Request $request)
    {
        ...
        if ($status == 'Monthly' && $is_thr == null) {
            ...
            if ($date) {
                ...
                return $pdf->setPaper([0, 0, 609.4488, 935.433], 'landscape')->stream('PrintAll.pdf');
            } else {
        ...
        } elseif ($status == 'Contract BSKP' && $is_thr == null) {
            $salaries = DB::table('salary_months')
                ->join('salary_years', 'salary_years.id', '=', 'salary_months.id_salary_year')
                ->join('grade', 'salary_years.id_salary_grade', '=', 'grade.id')
                ->join('users', 'users.nik', '=', 'salary_years.nik')
        ...
        } elseif ($status == 'Contract BSKP' && $is_thr == 'yes') {
            $salaries = DB::table('salary_months')
                ->join('salary_years', 'salary_years.id', '=', 'salary_months.id_salary_year')
                ->join('grade', 'salary_years.id_salary_grade', '=', 'grade.id')
                ->join('users', 'users.nik', '=', 'salary_years.nik')
    ...
    public function printallocation()
    {
        ...
        if ($status == 'Manager Staff') {
            ...
            return $pdf->setPaper([0, 0, 609.4488, 935.433], 'landscape')->stream('PrintAllocation.pdf');
        } else {
