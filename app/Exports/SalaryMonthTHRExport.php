...
class SalaryMonthTHRExport implements FromCollection, WithHeadings, WithStyles, WithEvents
{
    ...
    public function collection()
    {
        $query = DB::table('salary_months')
            ...
            ->select('salary_months.id', 'users.nik', 'users.name', 'grade.name_grade', 'salary_months.hour_call', 'salary_months.thr', 'salary_months.bonus', 'salary_months.incentive', 'salary_months.salary_backpay', 'salary_months.union', 'salary_months.absent', 'salary_months.electricity', 'salary_months.cooperative', 'salary_months.pinjaman', 'salary_months.other', 'salary_months.date')
