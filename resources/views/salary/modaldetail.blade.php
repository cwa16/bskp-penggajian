                        ...
                        <div class="col">
                            <table class="tb-detail">
                                ...
                                <tr>
                                    <td>Ability</td>
                                    <td>:</td>
                                    <td class="text-end">{{ number_format($sal->ability, 0, ',', '.') }}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td class="text-end">
                                        {{ number_format($sal->adjustment, 0, ',', '.') }}</td>
                                </tr>
                                <tr>
                        ...
                        <div class="col">
                            <table class="tb-detail">
                                ...
                                <tr>
                                    <td>Jamsostek</td>
                                    <td>:</td>
                                    <td class="text-end">{{ number_format($sal->jamsostek, 0, ',', '.') }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>Union</td>
                        ...
                        <div class="col">
                            ...
                            <table class="tb-detail">
                                ...
                                <tr>
                                    <td>Tax PPh 21</td>
                                    <td>:</td>
                                    {{-- <td class="text-end">{{ number_format($sal->pph21_ded, 0, ',', '.') ?? '' }}</td> --}}
                                    <td class="text-end">100.000</td>
                                </tr>
                                <tr class="top-border">
                                    <td><b>Sub Total</b></td>
