                        ...
                        <table class="table table-small table-striped table-hover dtTable align-items-center compact">
                            <thead>
                                <tr>
                                    ...
                                    <th style="background-color: #1A73E8;color: white;">Grade Name</th>
                                    <th style="background-color: #1A73E8;color: white;">Rate Salary</th>
                                    <th style="background-color: #1A73E8;color: white;">Year</th>
                        ...
                        <form action="{{ route('grade.store') }}" method="post" class="add_edit_grade">
                            ...
                            <div class="card-body py-0">
                                <div class="input-group input-group-outline my-3">
                                    ...
                                    <input type="number" class="form-control" name="rate_salary">
                                </div>
                            </div>
                            <div class="card-body py-0">
                                <div class="input-group input-group-outline my-3">
                        ...
                        <div class="card card-plain">
                            ...
                            <form action="{{ route('grade.update', $grade->id) }}" method="post" class="add_edit_grade">
                                ...
                                <div class="card-body py-0">
                                    <div class="input-group input-group-outline my-3 is-focused">
                                        <label class="form-label">Rate Salary</label>
                                        <input type="text" class="form-control" name="rate_salary"
                                            value="{{ $grade->rate_salary }}">
                                    </div>
                                </div>
                                <div class="card-body py-0">
                                    <div class="input-group input-group-outline my-3 is-focused">
